const PHONES = [
    {
        id: 1, name: 'Nexus S', src: require("../../../assets/img/phones/nexus-s.0.jpg"), price: 99.99,
    ...
    {
        id: 2, name: 'Dell Venue', src: require("../../../assets/img/phones/dell-venue.0.jpg"), price: 109.99,
    ...
    {
        id: 3, name: 'Droid 2', src: require("../../../assets/img/phones/droid-2-global-by-motorola.0.jpg"), price: 89.99,
    ...
    {
        id: 4, name: 'Droid Pro', src: require("../../../assets/img/phones/droid-pro-by-motorola.0.jpg"), price: 129.99,
    ...
    {
        id: 5, name: 'Motorola Bravo', src: require("../../../assets/img/phones/motorola-bravo-with-motoblur.0.jpg"), price: 119.99,
    ...
    {
        id: 6, name: 'Motorola Defy', src: require("../../../assets/img/phones/motorola-defy-with-motoblur.0.jpg"), price: 139.99,
